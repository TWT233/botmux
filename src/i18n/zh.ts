...
export const messages: Record<string, string> = {
  ...
  // ─── 独立旁问结果卡 ─────────────────────────────────────────────────────
  'btw.card.title': '旁问',
  'btw.card.question': '问题',
  'btw.card.status': '状态',
  'btw.card.answer': '完整答案',
  'btw.card.detail': '详情',
  'btw.card.received': '旁问已接收',
  'btw.card.running': '旁问进行中',
  'btw.card.completed': '旁问已完成',
  'btw.card.failed': '旁问失败',
  'btw.card.cancelled': '旁问已取消',
  'btw.card.interrupted': '旁问已中断',
  'btw.card.submission_unknown': '旁问提交状态未知',
  'btw.card.card_unknown': '旁问卡片状态未知',
  'btw.card.delivery_failed': '旁问结果投递失败',
  'btw.card.default_failed': '旁问执行失败',
  'btw.card.default_cancelled': '旁问已取消',
  'btw.card.default_interrupted': '旁问执行被中断',
  'btw.card.default_submission_unknown': '旁问是否已提交无法确认',
