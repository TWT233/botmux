...
export const messages: Record<string, string> = {
  ...
  // ─── Independent side-question card ─────────────────────────────────────
  'btw.card.title': 'Side question',
  'btw.card.question': 'Question',
  'btw.card.status': 'Status',
  'btw.card.answer': 'Full answer',
  'btw.card.detail': 'Details',
  'btw.card.received': 'Side question received',
  'btw.card.running': 'Side question running',
  'btw.card.completed': 'Side question completed',
  'btw.card.failed': 'Side question failed',
  'btw.card.cancelled': 'Side question cancelled',
  'btw.card.interrupted': 'Side question interrupted',
  'btw.card.submission_unknown': 'Side question submission unknown',
  'btw.card.card_unknown': 'Side question card status unknown',
  'btw.card.delivery_failed': 'Side question delivery failed',
  'btw.card.default_failed': 'The side question failed',
  'btw.card.default_cancelled': 'The side question was cancelled',
  'btw.card.default_interrupted': 'The side question was interrupted',
  'btw.card.default_submission_unknown': 'Whether the side question was submitted could not be confirmed',
