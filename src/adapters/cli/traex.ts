...
export function createTraexAdapter(pathOverride?: string): CliAdapter {
  ...
  return {
    ...
    buildArgs({ sessionId, resume, resumeSessionId, workingDir, model, reasoningEffort, disableCliBypass, bypassHookTrust, remoteWsUrl, remoteThreadId, nativeSubagentRuntimeHookCommand }) {
